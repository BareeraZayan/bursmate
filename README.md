...
BursMate uses Groq's `openai/gpt-oss-120b` model  model in two places, and both prompts are ones I wrote and iterated on myself.
...
- Frontend: Vite + React
- AI model: Groq's `openai/gpt-oss-120b` model 
